...
%% Car data
% Distances
param.trackwidthF = 1.24;
param.trackwidthR = 1.18;
...
param.gear_ratio = 45/11;
param.rdyn = 0.225;
param.wheel_inertia = 0.85;
param.torque_limit_positive = [0; 0; 230/2; 230/2];
param.torque_limit_negative = -[70; 70; 70; 70]; % PROVISIONAL TODO PEDALERA
