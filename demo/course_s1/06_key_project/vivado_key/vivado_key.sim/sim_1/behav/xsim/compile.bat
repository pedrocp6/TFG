...
REM
REM Generated by Vivado on Thu Jan 22 12:26:33 +0100 2026
...
echo "xvlog --incr --relax -prj key_test_tb_vlog.prj"
call xvlog  --incr --relax -prj key_test_tb_vlog.prj -log xvlog.log
