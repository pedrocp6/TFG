...
entity bd_d92b_csc_0_start_for_v_csc_core_U0 is 
    generic (
...
architecture rtl of bd_d92b_csc_0_start_for_v_csc_core_U0 is
...
------------------------Component----------------------
    component bd_d92b_csc_0_start_for_v_csc_core_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_bd_d92b_csc_0_start_for_v_csc_core_U0_ShiftReg : bd_d92b_csc_0_start_for_v_csc_core_U0_ShiftReg
    generic map (
...
entity bd_d92b_csc_0_start_for_v_csc_core_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end bd_d92b_csc_0_start_for_v_csc_core_U0_ShiftReg;

architecture rtl of bd_d92b_csc_0_start_for_v_csc_core_U0_ShiftReg is
