...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("m_axis_video_TDATA", 48, hls_out, 43, "axis", "out_data", 1),
	Port_Property("m_axis_video_TKEEP", 6, hls_out, 44, "axis", "out_data", 1),
	Port_Property("m_axis_video_TSTRB", 6, hls_out, 45, "axis", "out_data", 1),
