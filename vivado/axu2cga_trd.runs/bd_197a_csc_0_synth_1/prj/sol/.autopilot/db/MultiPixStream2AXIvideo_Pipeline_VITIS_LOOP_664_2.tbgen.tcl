set moduleName MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2
set isTopModule 0
...
set cdfgNum 17
set C_modelName {MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_664_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ sof int 1 regular  }
	{ OutVideoFormat_load int 8 regular {ap_stable 0} }
	{ trunc_ln9 int 10 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sof", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "OutVideoFormat_load", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln9", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add_ln677", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ stream_out_hresampled_dout sc_in sc_lv 48 signal 11 } 
	{ stream_out_hresampled_empty_n sc_in sc_logic 1 signal 11 } 
	{ stream_out_hresampled_read sc_out sc_logic 1 signal 11 } 
	{ stream_out_hresampled_num_data_valid sc_in sc_lv 5 signal 11 } 
	{ stream_out_hresampled_fifo_cap sc_in sc_lv 5 signal 11 } 
	{ m_axis_video_TREADY sc_in sc_logic 1 outacc 3 } 
	{ sof sc_in sc_lv 1 signal 0 } 
	{ OutVideoFormat_load sc_in sc_lv 8 signal 1 } 
	{ trunc_ln9 sc_in sc_lv 10 signal 2 } 
	{ m_axis_video_TDATA sc_out sc_lv 48 signal 3 } 
	{ m_axis_video_TVALID sc_out sc_logic 1 outvld 9 } 
	{ m_axis_video_TKEEP sc_out sc_lv 6 signal 4 } 
	{ m_axis_video_TSTRB sc_out sc_lv 6 signal 5 } 
	...
	{ add_ln677 sc_in sc_lv 10 signal 10 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "OutVideoFormat_load", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "OutVideoFormat_load", "role": "default" }} , 
 	{ "name": "trunc_ln9", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "trunc_ln9", "role": "default" }} , 
 	...
 	{ "name": "add_ln677", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "add_ln677", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	OutVideoFormat_load { ap_stable {  { OutVideoFormat_load in_data 0 8 } } }
	trunc_ln9 { ap_none {  { trunc_ln9 in_data 0 10 } } }
	...
	add_ln677 { ap_none {  { add_ln677 in_data 0 10 } } }
