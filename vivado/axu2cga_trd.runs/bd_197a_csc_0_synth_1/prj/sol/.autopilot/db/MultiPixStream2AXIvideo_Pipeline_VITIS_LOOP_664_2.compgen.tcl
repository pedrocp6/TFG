...
eval "cg_default_interface_gen_dc { \
    id 233 \
    name OutVideoFormat_load \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_OutVideoFormat_load \
    op interface \
    ports { OutVideoFormat_load { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln677 \
    op interface \
    ports { add_ln677 { I 10 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_out_hresampled_dout { I 48 vector } stream_out_hresampled_empty_n { I 1 bit } stream_out_hresampled_read { O 1 bit } stream_out_hresampled_num_data_valid { I 5 vector } stream_out_hresampled_fifo_cap { I 5 vector } } \
} "
}
