...
module bd_197a_csc_0_hls_deadlock_idx0_monitor ( // for module bd_197a_csc_0_v_csc_inst
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[5] = idx5_block & (1'b0 | axis_block_sigs[3]);
...
// instant sub module
 bd_197a_csc_0_hls_deadlock_idx1_monitor bd_197a_csc_0_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
