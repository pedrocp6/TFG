...
entity bd_197a_csc_0_fifo_w1_d2_S is 
    generic (
...
architecture rtl of bd_197a_csc_0_fifo_w1_d2_S is
...
------------------------Component----------------------
    component bd_197a_csc_0_fifo_w1_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_bd_197a_csc_0_fifo_w1_d2_S_ShiftReg : bd_197a_csc_0_fifo_w1_d2_S_ShiftReg
    generic map (
...
entity bd_197a_csc_0_fifo_w1_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end bd_197a_csc_0_fifo_w1_d2_S_ShiftReg;

architecture rtl of bd_197a_csc_0_fifo_w1_d2_S_ShiftReg is
