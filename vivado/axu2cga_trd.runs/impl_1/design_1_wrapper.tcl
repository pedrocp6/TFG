namespace eval ::optrace {
  variable script "C:/TFG_Vivado/vivado/axu2cga_trd.runs/impl_1/design_1_wrapper.tcl"
...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/TFG_Vivado/vivado/axu2cga_trd.cache/wt [current_project]
